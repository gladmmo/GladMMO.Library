...
namespace GladMMO
{
	...
	public sealed class ClientCharacterControllerInputMovementGenerator : CharacterControllerInputMovementGenerator
	{
		...
		public ClientCharacterControllerInputMovementGenerator(MovementBlockData movementData, Lazy<CharacterController> controller, bool shouldSetRotation = true) 
		...
		protected override Vector3 Start(GameObject entity, long currentTime)
		{
			...
			entity.transform.position = MovementData.MoveInfo.Position.ToUnityVector();
			...
			return MovementData.MoveInfo.Position.ToUnityVector();
		}
	}
}
