...
namespace GladMMO
{
	public sealed partial class TrinityCoreCharactersRepository : BaseGenericBackedDatabaseRepository<wotlk_charactersContext, uint, Characters>, ITrinityCharactersRepository
	{
		private wotlk_worldContext WorldContext { get; }

		private ITrinityCharacterActionRepository ActionBarRepository { get; }

		public TrinityCoreCharactersRepository(wotlk_charactersContext context, [JetBrains.Annotations.NotNull] wotlk_worldContext worldContext,
			[JetBrains.Annotations.NotNull] ITrinityCharacterActionRepository actionBarRepository) 
			: this(context)
		{
