...
namespace GladMMO
{
	...
	public sealed class CreatureInstanceNetworkToTableTypeConverter : ITypeConverterProvider<CreatureInstanceModel, CreatureEntryModel>
	{
		public CreatureEntryModel Convert([NotNull] CreatureInstanceModel fromObject)
		{
			...
			return new CreatureEntryModel(fromObject.TemplateId, new Vector3<float>(fromObject.InitialPosition.x, fromObject.InitialPosition.y, fromObject.InitialPosition.z), fromObject.YAxisRotation, int.MaxValue);
		}
	}
}
