...
namespace GladMMO
{
	...
	public sealed class GameObjectInstanceNetworkToTableTypeConverter : ITypeConverterProvider<GameObjectInstanceModel, GameObjectEntryModel>
	{
		public GameObjectEntryModel Convert([NotNull] GameObjectInstanceModel fromObject)
		{
			...
			return new GameObjectEntryModel(fromObject.TemplateId, new GladMMO.Database.Vector3<float>(fromObject.InitialPosition.x, fromObject.InitialPosition.y, fromObject.InitialPosition.z), fromObject.YAxisRotation, int.MaxValue);
		}
	}
}
