...
namespace GladMMO
{
	...
	public sealed class TargetUnitFrameUIControllerEventListener : DataChangedLocalPlayerSpawnedEventListener, ILocalPlayerTargetChangedEventListener
	{
		...
		private void OnPlayerTargetDisappeared()
		{
			...
			SendService.SendMessage(new CMSG_SET_SELECTION_Payload(ObjectGuid.Empty));
		}

		protected override void OnLocalPlayerSpawned(LocalPlayerSpawnedEventArgs args)
		{
			RegisterPlayerDataChangeCallback<ulong>(EUnitFields.UNIT_FIELD_TARGET, OnPlayerTargetEntityDataChanged);
		}

		private void OnPlayerTargetEntityDataChanged(ObjectGuid entity, EntityDataChangedArgs<ulong> changeArgs)
		{
